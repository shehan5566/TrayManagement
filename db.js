...
const ApprovalRequestSchema = new mongoose.Schema({
    ...
    pendingDepositBalance: { type: Number, default: 0 },
    refundableOutstanding: { type: Number, default: 0 },
    currentBalance: { type: Number, default: 0 },
...
const ApprovalRequest = {
    create: async (data) => {
        ...
        const doc = new ApprovalRequestModel({
            ...
            pendingDepositBalance: data.pendingDepositBalance || 0,
            refundableOutstanding: data.refundableOutstanding || 0,
